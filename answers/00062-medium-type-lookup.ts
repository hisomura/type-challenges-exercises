/**
 * @see https://github.com/type-challenges/type-challenges/blob/main/questions/00062-medium-type-lookup/README.md
 */
/*
  62 - Type Lookup
  -------
...
type LookUp<U extends {type: AnimalType}, T extends AnimalType> = U extends {type: T} ? U : never
