/**
 * @see https://github.com/type-challenges/type-challenges/blob/main/questions/00189-easy-awaited/README.md
 */
/*
  189 - Awaited
  -------
...
type PromiseLike<T> = Pick<Promise<T>, 'then'>
type MyAwaited<T extends PromiseLike<any>> =
  T extends PromiseLike<infer Answer> ?
    Answer extends PromiseLike<any> ? MyAwaited<Answer> : Answer
    : never
